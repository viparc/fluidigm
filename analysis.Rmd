...
plot(NA, xlim = c(0, max(cc$end, na.rm = TRUE)), ylim = c(0, (max(cc$y) + 1)), type = "n", xlab = "age of flock (days)", ylab = "", axes = FALSE, xaxs = "i", yaxs = "i")
box(bty = "o")
axis(1)
with(cc, segments(AgeUse_Day, y, end, y, col = "red"))
abline(h = b, col = "grey")
abline(v = 0)
abline(v = seq(7, 100, 7), col = "grey")
```
